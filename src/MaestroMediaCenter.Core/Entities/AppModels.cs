...
{
    [Key] public Guid VideoSourceRootId { get; set; }
...
{
    [Key] public Guid VideoServerAlternateId { get; set; }
...
{
    [Key] public Guid VideoSourceId { get; set; }
...
{
    [ForeignKey(nameof(Entities.Video))] public Guid VideoId { get; set; }

    public Video? Video { get; set; }
    [ForeignKey(nameof(Profile))] public Guid ProfileId { get; set; }
...
public record AccountEmail : TenantTable
{
    ...
    [ForeignKey(nameof(AccountUser))] public Guid UserId { get; set; }
...
{
    [Key] public Guid VideoCollectionId { get; set; }
    [ForeignKey(nameof(AccountUser))] public required string VideoCollectionName { get; set; }
...
{
    [Key] public Guid VideoCollectionItemId { get; set; }
    [ForeignKey(nameof(VideoCollection))] public Guid VideoCollectionId { get; set; }
    [ForeignKey(nameof(Entities.Video))] public Guid VideoId { get; set; }
...
{
    [Key] public Guid VideoMetadataId { get; set; }
